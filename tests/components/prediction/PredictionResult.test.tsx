...
describe("PredictionResult", () => {
  it("予測結果が正しく表示される", () => {
    render(<PredictionResult predictions={mockPredictionResponse.predictions} />);
  ...
  it("6個以上の予測結果では2行グリッドレイアウトになる", () => {
    const { container } = render(
      <PredictionResult predictions={mockPredictionResponseWith10Classes.predictions} />
    );
  ...
  it("10個の予測結果すべてが表示される", () => {
    render(<PredictionResult predictions={mockPredictionResponseWith10Classes.predictions} />);
